...
#building on nse_7 video
#reading financials-historical-quarterly
...
try:
    for item in df['link']:
        ...
        if company!='':#'coal-india-ltd_coalindia':
            ...
            stock_index_file_in=Path(stock_path +'\\'+ company +'\\financials-historical-quarterly')
...
##                    for count in counts:
                    ...
                    if len(row_data)==5:
                        ...
                        if count!=len(tr_total):
                            ...
                            #time.sleep(1)
                        if count==15:
                            print('---------New Dataset result_df is ready')
...
##                        df1[]
       ...
       # time.sleep(1)
    result_df.to_csv('quaterly_fin.csv')
    #three stock tickers have been modifed in quaterly_fin_modified.csv
    #they are :
    #VEDL for SESAGOA
    #INFRATEL for BINFRA
    #ACC for ACCLTD 
