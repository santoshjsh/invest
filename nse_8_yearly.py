...
#reading financials_historical-yearly files
...
try:
    for item in df['link']:
        ...
        if company!='':#'coal-india-ltd_coalindia':
            ...
            stock_index_file_in=Path(stock_path +'\\'+ company +'\\financials-historical-yearly')
...
##                        df1[]
       ...
       # time.sleep(1)
    result_df.to_csv('yearly_fin.csv')
